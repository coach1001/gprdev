...
CREATE TABLE calls (
    ...
    call_budget numeric(20,2),
    call_reference_path_safe character varying(50) DEFAULT ''::character varying NOT NULL
);
...
--
-- Name: calc_call_path(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION calc_call_path() RETURNS void
    LANGUAGE plpgsql COST 1
    AS $$
BEGIN	
	SET ROLE postgres;
...
ALTER FUNCTION public.calc_call_path() OWNER TO postgres;

--
-- Name: calc_call_path_tf(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION calc_call_path_tf() RETURNS trigger
    LANGUAGE plpgsql COST 1
    AS $$
BEGIN	
	SET ROLE postgres;
...
ALTER FUNCTION public.calc_call_path_tf() OWNER TO postgres;
...
--
-- Name: demote_application(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION demote_application(application integer, current_section integer) RETURNS void
    LANGUAGE plpgsql COST 1
    AS $$
...
ALTER FUNCTION public.demote_application(application integer, current_section integer) OWNER TO postgres;
...
--
-- Name: lookup_compliance_applications; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW lookup_compliance_applications AS
 SELECT call_applications.id AS application,
    calls.call_reference,
    organisations.name,
    call_applications.application_status,
   ...
   FROM (((call_applications
     ...
     JOIN calls ON ((call_applications.call = calls.id)))
     JOIN call_application_statuses ON ((call_applications.application_status = call_application_statuses.id)))
  WHERE (call_applications.application_status < 13);


ALTER TABLE lookup_compliance_applications OWNER TO postgres;

--
-- Name: lookup_compliance_officers; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW lookup_compliance_officers AS
 SELECT persons.id,
    ...
    persons.email_address
   FROM persons
  WHERE (persons.application_user = true);


ALTER TABLE lookup_compliance_officers OWNER TO postgres;
...
--
-- Name: calc_call_path_tf; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER calc_call_path_tf BEFORE INSERT OR UPDATE ON calls FOR EACH ROW EXECUTE PROCEDURE calc_call_path_tf();
...
--
-- Name: lookup_compliance_applications; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE lookup_compliance_applications FROM PUBLIC;
REVOKE ALL ON TABLE lookup_compliance_applications FROM postgres;
GRANT ALL ON TABLE lookup_compliance_applications TO postgres;
GRANT ALL ON TABLE lookup_compliance_applications TO gpr_lookup_maintainer;


--
-- Name: lookup_compliance_officers; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE lookup_compliance_officers FROM PUBLIC;
REVOKE ALL ON TABLE lookup_compliance_officers FROM postgres;
GRANT ALL ON TABLE lookup_compliance_officers TO postgres;
GRANT ALL ON TABLE lookup_compliance_officers TO gpr_lookup_maintainer;
